...
Contributing to the documentation benefits everyone who uses {{ cookiecutter.project_slug }}. We
encourage you to help us improve the documentation, and you don't have to be an
expert on {{ cookiecutter.project_slug }} to do so! In fact, there are sections of the docs that are
...
- The {{ cookiecutter.project_slug }} documentation consists of two parts: the docstrings in the code
